        ...
        <div className="mb-14 glass-panel rounded-none p-8 border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              { icon: "hub", step: "3", title: "Compatibility Engine", desc: "Scores 8 behavioral dimensions across the team and flags weak/strong alignment with uncertainty." },
              { icon: "auto_awesome", step: "4", title: "Claude Synthesis", desc: "Streams a narrative report with strengths, risks, confidence notes, and meeting-window suggestions." },
            ].map((item) => (
