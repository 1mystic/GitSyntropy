...
innovation_drive=1, leadership_orientation=2, team_resilience=3, work_style=4,
decision_style=5, risk_tolerance=6, stress_response=7, chronotype_sync=8
...
apps/backend/
  ...
  app/schemas.py                  — TRAIT_DIMENSIONS, TRAIT_WEIGHTS
```
